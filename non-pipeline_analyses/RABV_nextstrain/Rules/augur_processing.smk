...
rule translate_tree_sequences:
    ...
    output:
        ...
        gene_alignments = expand("Results/Gene_AA_Alignements/RABV_{gene}.fasta", gene=["Glycoprotein", "Nucleoprotein", "Matrix", "Phosphoprotein", "Polymerase"]),
    conda:
        "../environment.yml",
    shell:
        "augur translate "
        ...
        "--genes Glycoprotein Nucleoprotein Matrix Phosphoprotein Polymerase "
        "--alignment-output Results/Gene_AA_Alignements/RABV_%GENE.fasta"
